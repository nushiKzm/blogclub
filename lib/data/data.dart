...
class AppDatabase {
  //فقط خواندنی : چون  فقط گت مشخص کردیم
  ...
  static List<OnBoardingItem> get onBoardingItems {
    return [
      OnBoardingItem(
        'Read the article you want instantly 1',
        'You can read thousands of articles on Blog Club, save them in the application and share them with your loved ones.',
      ),
      OnBoardingItem(
        'Read the article you want instantly 2',
        'You can read thousands of articles on Blog Club, save them in the application and share them with your loved ones.',
      ),
      OnBoardingItem(
        'Read the article you want instantly 3',
        'You can read thousands of articles on Blog Club, save them in the application and share them with your loved ones.',
      ),
      OnBoardingItem(
        'Read the article you want instantly 4',
        'You can read thousands of articles on Blog Club, save them in the application and share them with your loved ones.',
      ),
    ];
  }
