...
class $AssetsImgGen {
  ...
  $AssetsImgArticleGen get article => const $AssetsImgArticleGen();
...
class $AssetsImgArticleGen {
  const $AssetsImgArticleGen();

  /// File path: assets/img/article/single_post.png
  AssetGenImage get singlePost =>
      const AssetGenImage('assets/img/article/single_post.png');

  /// List of all assets
  List<AssetGenImage> get values => [singlePost];
}
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/flutter.svg
  SvgGenImage get flutter => const SvgGenImage('assets/img/icons/flutter.svg');
